...
const URL_CATEGORY = 'https://api.themoviedb.org/3/genre/movie/list?api_key=8c9751844a68e8e7105d68bd90f6eb25&language=en-US';
...
async function movieFetcher(req: Request, res: Response){
    ...
    const getCategories = await axios(URL_CATEGORY);
